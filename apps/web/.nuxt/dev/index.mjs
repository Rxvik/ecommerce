...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, createError, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, getQuery as getQuery$1, getRequestWebStream, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, getRouterParam, readBody, getResponseStatusText } from 'file:///home/ruvik/Documentos/LenguajesModernos/nodejs-monorepo/node_modules/@nuxt/nitro-server/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///home/ruvik/Documentos/LenguajesModernos/nodejs-monorepo/node_modules/@vue/shared/dist/shared.cjs.js';
import viteNodeEntry_mjs from 'file:///home/ruvik/Documentos/LenguajesModernos/nodejs-monorepo/node_modules/@nuxt/vite-builder/dist/vite-node-entry.mjs';
import { viteNodeFetch } from 'file:///home/ruvik/Documentos/LenguajesModernos/nodejs-monorepo/node_modules/@nuxt/vite-builder/dist/vite-node.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, parseQuery, parsePath, encodePath, joinRelativeURL } from 'file:///home/ruvik/Documentos/LenguajesModernos/nodejs-monorepo/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file:///home/ruvik/Documentos/LenguajesModernos/nodejs-monorepo/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///home/ruvik/Documentos/LenguajesModernos/nodejs-monorepo/node_modules/nitropack/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///home/ruvik/Documentos/LenguajesModernos/nodejs-monorepo/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///home/ruvik/Documentos/LenguajesModernos/nodejs-monorepo/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///home/ruvik/Documentos/LenguajesModernos/nodejs-monorepo/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/ruvik/Documentos/LenguajesModernos/nodejs-monorepo/node_modules/unstorage/drivers/fs.mjs';
import { digest, hash as hash$1 } from 'file:///home/ruvik/Documentos/LenguajesModernos/nodejs-monorepo/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///home/ruvik/Documentos/LenguajesModernos/nodejs-monorepo/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///home/ruvik/Documentos/LenguajesModernos/nodejs-monorepo/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///home/ruvik/Documentos/LenguajesModernos/nodejs-monorepo/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///home/ruvik/Documentos/LenguajesModernos/nodejs-monorepo/node_modules/nitropack/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/ruvik/Documentos/LenguajesModernos/nodejs-monorepo/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///home/ruvik/Documentos/LenguajesModernos/nodejs-monorepo/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///home/ruvik/Documentos/LenguajesModernos/nodejs-monorepo/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///home/ruvik/Documentos/LenguajesModernos/nodejs-monorepo/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///home/ruvik/Documentos/LenguajesModernos/nodejs-monorepo/node_modules/source-map/source-map.js';
import { defineDiagnostics, createConsoleReporter } from 'file:///home/ruvik/Documentos/LenguajesModernos/nodejs-monorepo/node_modules/nostics/dist/index.mjs';
import { ansiFormatter } from 'file:///home/ruvik/Documentos/LenguajesModernos/nodejs-monorepo/node_modules/nostics/dist/formatters/ansi.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///home/ruvik/Documentos/LenguajesModernos/nodejs-monorepo/node_modules/devalue/index.js';
import { getContext as getContext$1 } from 'file:///home/ruvik/Documentos/LenguajesModernos/nodejs-monorepo/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///home/ruvik/Documentos/LenguajesModernos/nodejs-monorepo/node_modules/errx/dist/index.mjs';
import { isVNode, isRef, toValue } from 'file:///home/ruvik/Documentos/LenguajesModernos/nodejs-monorepo/node_modules/vue/index.mjs';
import _wH6JrtIxmaSoA8lCPWFnE9z4lQeXW6H5z3l5aymEQw from 'file:///home/ruvik/Documentos/LenguajesModernos/nodejs-monorepo/node_modules/@nuxt/vite-builder/dist/fix-stacktrace.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file:///home/ruvik/Documentos/LenguajesModernos/nodejs-monorepo/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file:///home/ruvik/Documentos/LenguajesModernos/nodejs-monorepo/node_modules/@iconify/utils/lib/index.js';
import { collections } from 'file:///home/ruvik/Documentos/LenguajesModernos/nodejs-monorepo/apps/web/.nuxt/nuxt-icon-server-bundle.mjs';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///home/ruvik/Documentos/LenguajesModernos/nodejs-monorepo/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { renderToString } from 'file:///home/ruvik/Documentos/LenguajesModernos/nodejs-monorepo/node_modules/vue/server-renderer/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///home/ruvik/Documentos/LenguajesModernos/nodejs-monorepo/node_modules/unhead/dist/server.mjs';
import { walkResolver } from 'file:///home/ruvik/Documentos/LenguajesModernos/nodejs-monorepo/node_modules/unhead/dist/utils.mjs';
import { DeprecationsPlugin } from 'file:///home/ruvik/Documentos/LenguajesModernos/nodejs-monorepo/node_modules/unhead/dist/legacy.mjs';
import { PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///home/ruvik/Documentos/LenguajesModernos/nodejs-monorepo/node_modules/unhead/dist/plugins.mjs';

const serverAssets = [{"baseName":"server","dir":"/home/ruvik/Documentos/LenguajesModernos/nodejs-monorepo/apps/web/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/ruvik/Documentos/LenguajesModernos/nodejs-monorepo/apps/web","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/ruvik/Documentos/LenguajesModernos/nodejs-monorepo/apps/web/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/ruvik/Documentos/LenguajesModernos/nodejs-monorepo/apps/web/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/ruvik/Documentos/LenguajesModernos/nodejs-monorepo/apps/web/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/ruvik/Documentos/LenguajesModernos/nodejs-monorepo/apps/web/.data/kv"}));
...
const _nfc6IBRMxgkgjINNXZqPMb3kpqlSr6SmfpMg385Qrd4 = (function(nitro) {
...
const rootDir = "/home/ruvik/Documentos/LenguajesModernos/nodejs-monorepo/apps/web";
...
const plugins = [
  _nfc6IBRMxgkgjINNXZqPMb3kpqlSr6SmfpMg385Qrd4,
...
const _iOTPDO = eventHandler((event) => {
...
const _F86Mx4 = defineCachedEventHandler(async (event) => {
...
const _lazy_3afbKz = () => Promise.resolve().then(function () { return renderer; });

const handlers = [
  { route: '', handler: _iOTPDO, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_3afbKz, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _F86Mx4, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: handler$1, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_3afbKz, lazy: true, middleware: false, method: undefined }
];
